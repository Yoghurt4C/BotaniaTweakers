...
public class TerraPlateRecipeJS extends RecipeJS {
    private int mana;
    ...
    public void create(ListJS args) {
        ...
        this.mana = Math.max(0, TweakerUtil.toInt(args.get(i)));
    }
    ...
    public void deserialize() {
        ...
        this.outputItems.add(ItemStackJS.of(json.get("result")));
        ...
        this.mana = Math.max(0, JsonHelper.getInt(json, "mana", 500000));
    }
